                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'title'">{{ trans('admin.order.columns.title') }}</th>
                                        <th is='sortable' :column="'categories'">{{ trans('admin.order.columns.categories') }}</th>
                                        <th is='sortable' :column="'products'">{{ trans('admin.order.columns.products') }}</th>
                                        <th is='sortable' :column="'cost'">{{ trans('admin.order.columns.cost') }}</th>
                                        <th is='sortable' :column="'user_id'">{{ trans('admin.order.columns.user_id') }}</th>
                                        <th is='sortable' :column="'active'">{{ trans('admin.order.columns.active') }}</th>
                                        <th is='sortable' :column="'complete'">{{ trans('admin.order.columns.complete') }}</th>
